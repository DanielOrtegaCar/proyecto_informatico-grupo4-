...
-- -----------------------------------------------------
-- Table `proyinf4`.`Deporte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Deporte` (
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Division`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Division` (
  ...
  CONSTRAINT `deporteid`
    ...
    REFERENCES `proyinf4`.`Deporte` (`deporteid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Equipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Equipo` (
  ...
  CONSTRAINT `divisionid`
    ...
    REFERENCES `proyinf4`.`Division` (`divisionid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Jugador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Jugador` (
  ...
  CONSTRAINT `equipoid`
    ...
    REFERENCES `proyinf4`.`Equipo` (`equipoid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Lugar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Lugar` (
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Partido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Partido` (
  ...
  CONSTRAINT `lugarid`
    FOREIGN KEY (`lugarid`)
    REFERENCES `proyinf4`.`Lugar` (`lugarid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ganador`
    FOREIGN KEY (`ganador`)
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Campeonato`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Campeonato` (
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Arbitro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Arbitro` (
...
-- -----------------------------------------------------
-- Table `proyinf4`.`arbitraje`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`arbitraje` (
  ...
  CONSTRAINT `partidoid`
    ...
    REFERENCES `proyinf4`.`Partido` (`partidoid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `arbitroid`
    FOREIGN KEY (`arbitroid`)
    REFERENCES `proyinf4`.`Arbitro` (`arbitroid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyinf4`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`Usuario` (
...
CREATE TABLE IF NOT EXISTS `proyinf4`.`Sanciones` (
  ...
  CONSTRAINT `jugadorid0`
    ...
    REFERENCES `proyinf4`.`Jugador` (`jugadorid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `proyinf4`.`partido_jugador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyinf4`.`partido_jugador` (
  `partidoid` INT UNSIGNED NOT NULL,
  `jugadorid` INT UNSIGNED NOT NULL,
