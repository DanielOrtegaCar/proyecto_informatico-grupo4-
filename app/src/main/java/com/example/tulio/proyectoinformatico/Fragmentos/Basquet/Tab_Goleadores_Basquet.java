...
public class Tab_Goleadores_Basquet extends Fragment implements Callback<ArrayList<Goleadores>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle){
        View rootView= inflater.inflate(R.layout.basquet_goleadores, container, false);
        ...
        Call<ArrayList<Goleadores>> call = PruebaApiAdapter.getApiService().getTablaGoleadores1DivBasq();
        ...
        Call<ArrayList<Goleadores>> calls = PruebaApiAdapter.getApiService().getTablaGoleadoreswDivBasq();
        ...
        Call<ArrayList<Goleadores>> callt = PruebaApiAdapter.getApiService().getTablaGoleadores3DivBasq();
