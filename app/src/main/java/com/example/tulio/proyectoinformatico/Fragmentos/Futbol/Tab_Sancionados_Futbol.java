...
public class Tab_Sancionados_Futbol extends Fragment implements Callback<ArrayList<Sancionados>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle){
        View rootView= inflater.inflate(R.layout.futbol_sanciones, container, false);
        ...
        Call<ArrayList<Sancionados>> call = PruebaApiAdapter.getApiService().getTablaSanciones1DivFut();
        ...
        Call<ArrayList<Sancionados>> calls = PruebaApiAdapter.getApiService().getTablaSanciones2DivFut();
        ...
        Call<ArrayList<Sancionados>> callt = PruebaApiAdapter.getApiService().getTablaSancionesChamp();
